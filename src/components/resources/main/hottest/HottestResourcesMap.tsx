...
import { getHottestResourcesQuery } from './functions/getHottestResourcesQuery'

export default function HottestResourcesMap() {
  ...
  const {
    ...
    queryKey: ['hottestResources'],
    queryFn: ({ pageParam = 1 }) => getHottestResourcesQuery({ pageParam }),
    initialPageParam: 1,
