        ...
        <Popover>
          <PopoverTrigger className="flex gap-x-1">
            ...
            <Image
              ...
              width={128}
              height={128}
              className="hover:rounded[0.25-rem] h-[1.5rem] w-[1.5rem] rounded-[0.5rem]"
            ></Image>
          </PopoverTrigger>
          <PopoverContent>
            <div className="flex flex-col gap-y-2 pr-4">
              <div className="flex gap-x-2">
                ...
                <div className="flex flex-col text-left">
                  <Button
                    variant="link"
                    className="h-auto justify-start p-0 text-left text-zinc-400"
                    onClick={() => router.push(`/user/${audio.user?.username}`)}
                  >
                    @{audio.user?.username}
                  </Button>
                  <h3 className="text-md font-bold">{audio.fileData.name}</h3>
                </div>
              </div>
