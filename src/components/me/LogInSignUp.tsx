    ...
    <Tabs defaultValue="log-in" className="w-[400px]">
      ...
      <div className="oauth-container flex flex-row w-[100%] my-4 items-center justify-between">
        <Button
          ...
          className="o-auth-button flex w-[33.33%] flex-grow flex-row items-center justify-center"
        >
          {loading && loadingTarget === "discord" ? (
            <svg
              width="24"
              height="24"
              stroke="#0f0f0f"
        ...
        <Button
          ...
          className="o-auth-button flex w-[33.34%] mx-1 flex-row items-center justify-center"
        >
          {loading && loadingTarget === "spotify" ? (
            <svg
              width="24"
              height="24"
              stroke="#0f0f0f"
      ...
      <TabsContent value="log-in">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Log into your account using your email and password or any of our
              OAuth providers.
            </CardDescription>
          </CardHeader>
      ...
      <TabsContent value="sign-up">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Sign up for an account using your email and password or any of our
              OAuth providers.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-2">
            ...
            <div className="space-y-1">
              ...
              {signUpComplete && (
                <Alert variant="default">
                  ...
                  <AlertDescription>
                    A confirmation link has been sent to your email. Click it to
                    active your account.
                  </AlertDescription>
                </Alert>
              )}
