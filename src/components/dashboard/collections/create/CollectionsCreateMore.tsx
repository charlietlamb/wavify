...
import CollectionsCreateDraft from './CollectionsCreateDraft'
import CollectionsCreateDelete from './CollectionsCreateDelete'

export default function CollectionsCreateMore() {
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent>
          ...
          <div className="grid grid-cols-2 gap-4">
            <CollectionsCreateDraft setOpen={setOpen} />
            <CollectionsCreateDelete setOpen={setOpen} />
          </div>
        </DialogContent>
      </Dialog>
    </div>
